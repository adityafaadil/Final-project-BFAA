package com.dicoding.consumerapp.alarm
...
import com.dicoding.consumerapp.activity.MainActivity
    ...
    override fun onReceive(context: Context, intent: Intent) {
     ...
     fun setDailyReminder(context: Context, type: String, message: String){
        ...
        val pendingIntent = PendingIntent.getBroadcast(context, ID_DAILY, intent, PendingIntent.FLAG_ONE_SHOT)
         ...
         Toast.makeText(context, "Daily Reminder is turned ON", Toast.LENGTH_SHORT).show()
    }
     ...
     fun showAlarmNotification(context: Context, title: String?) {
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            ...
            .setContentText("jangan lupa buka apps nya yes? ada yang baru nich")
            .setAutoCancel(true)
